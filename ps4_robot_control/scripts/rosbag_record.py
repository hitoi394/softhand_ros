    ...
    if rospy.has_param('~filename'):
        ...
        rec_2 = Recorder(DIRECTORY + FILENAME + ".bag", 
                        topics=['/myrobot/left_camera/aligned_depth_to_color/image_raw', 
                                '/myrobot/left_camera/color/image_raw', 
                                '/myrobot/side_camera/aligned_depth_to_color/image_raw', 
                                '/myrobot/side_camera/color/image_raw', 
                                '/myrobot/body_camera/aligned_depth_to_color/image_raw', 
                                '/myrobot/body_camera/color/image_raw', 
                                '/cmd_vel/left', 
                                '/hand_angle', 
                                '/hand_ref_pressure', 
                                '/joy', 
